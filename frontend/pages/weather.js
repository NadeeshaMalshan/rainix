    ...
    <div className="min-h-screen relative overflow-hidden font-sans text-white transition-all duration-1000 ease-in-out">
      ...
      >
        ...
        <div className="absolute top-4 left-1/2 -translate-x-1/2 z-50 w-full max-w-sm text-center">
          <div className="flex w-[90%] max-w-md mx-auto items-start gap-3">
            <div className="flex-1 relative">
              ...
              >
                <input 
                  className={`flex-1 min-w-0 bg-transparent border-none text-left focus:ring-0 ${textColorClass} font-medium text-base md:text-lg placeholder:${textColorClass} placeholder:opacity-60 outline-none`}
                    ...
                    <>
                      {recentSearches.length > 0 && (
                        <div className="p-2 md:p-3 border-b border-white/10">
                          <div className="text-[9px] md:text-[10px] uppercase font-bold text-sky-400 px-3 py-1 flex items-center gap-1.5 text-left">
            ...
            <button 
              type="button" 
              className={`h-11 w-11 md:h-[3.25rem] md:w-[3.25rem] rounded-full flex-shrink-0 bg-white/20 backdrop-blur-md border border-white/30 hover:bg-white/30 transition-all duration-300 flex items-center justify-center ${textColorClass} shadow-lg`} 
        ...
        {!isLoading && !errorMsg && cityData && (
          <div className="flex-1 flex flex-col justify-center items-center w-full h-full relative z-40 main-weather-content animate-fade-in-up pt-20 md:pt-24">
            ...
            <div className="flex flex-col items-center">
              ...
              <div className="flex flex-row items-center mt-4 gap-3 md:gap-4">
                <span className={`text-2xl font-normal ${textColorClass} mb-2 `}>{weatherCondition.label}</span>
                
                <div className={`flex flex-wrap justify-center items-center gap-x-2.5 gap-y-2 text-xs md:text-base font-normal ${textColorClass}`}>
              ...
              {hasActiveWarning && (
                <div className="w-full flex items-center justify-center gap-2 mt-5 text-sm md:text-base font-normal select-none pointer-events-auto">
